...
class PhysicsSim():
    ...
    def reset(self):
        ...
        # sself.v = np.array([0.0, 0.0, 0.0]) if self.init_velocities is None else self.init_velocities
        self.v = np.array([0.0, 0.0, 0.0]) if self.init_velocities is None else np.copy(self.init_velocities)
        # sself.angular_v = np.array([0.0, 0.0, 0.0]) if self.init_angle_velocities is None else self.init_angle_velocities
